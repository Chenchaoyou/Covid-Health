...
```{r flipped race}
race$perwhite <- (race$White/race$Total_Pop)*100
race$perAfAm <- (race$African_American/race$Total_Pop)*100
race$perNatAm <- (race$Native_American/race$Total_Pop)*100
race$perAsian<- (race$Asian/race$Total_Pop)*100
race$perPacIsl- (race$`Hawaiian/Pacific_Islander`/race$Total_Pop)*100
ace$perPacIsl <- (race$`Hawaiian/Pacific_Islander`/race$Total_Pop)
> race$perOth <- (race$Other/race$Total_Pop)
> race$perTwo <- (race$Other/race$Total_Pop)
